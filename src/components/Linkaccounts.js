...
function LinkAccounts() {
    ...
    return (
        ...
        <div className="e_login_icons">
            <span className="e_login_icon"><FaFacebook /></span>
            <span  className="e_login_icon"><FaInstagram /></span>
            <span  className="e_login_icon"><FaTwitter /></span>
            <span  className="e_login_icon"><BsGoogle /></span>
            <span  className="e_login_icon"><FaSkype /></span>
        </div>
    );
}
